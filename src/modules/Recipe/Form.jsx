      ...
      >
        {({ isSubmitting, setFieldValue, values }) => (
          <Form className="space-y-4">
              ...
              >
                {({ field }) => (
                  <textarea
                    {...field}
                    id="description"
                    className="py-3 px-4  border rounded-md block w-full border-gray-200 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                    rows="3"
            ...
            <div>
              <label
                htmlFor="recommendedSalesPricePerPortion"
                className="block font-medium"
              >
    ...
    <div className="border-2 p-4 rounded-lg max-h-30">
      ...
      {ingredients.length > 0 ? (
        ingredients.map((item) => (
          <div
            key={item.id}
            className="border-2  rounded-lg flex flex-col justify-between items-center"
          >
            <div className="bg-green-500 p-4 w-full flex justify-between">
              <p className="font-semibold text-white">
                {Ingredient.find((u) => u.id == item.ingredientId).name}
              </p>
            ...
            <div className="px-6 text-start w-full">
              <p className="font-semibold">
                ...
                {units.find((u) => u.code == item.unitId).code}
              </p>
    ...
    <div className="border-2 p-4 rounded-lg max-h-30">
      ...
      >
        {({
          ...
          <>
            <div>
              <label htmlFor="ingredientId" className="block font-medium">
                Ingrediente
              </label>
              <Field
                as="select"
            ...
            <div>
              <label htmlFor="unitId" className="block font-medium">
                unidad
              </label>
              <Field
                as="select"
            ...
            <button
              ...
              disabled={
                formValues.portionPerRecipe == 0 ||
                formValues.preparationTime == 0
              }
